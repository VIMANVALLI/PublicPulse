      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-96">
        ...
        <form onSubmit={handleSignup}>
          <input
            ...
            className="w-full border p-2 rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-purple-400"
            value={username}
          ...
          <input
            ...
            className="w-full border p-2 rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-purple-400"
            value={password}
